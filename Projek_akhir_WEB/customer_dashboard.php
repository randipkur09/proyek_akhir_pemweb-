...
$stmt = $pdo->prepare("
    SELECT b.*, bs.nama_barbershop, bs.alamat as barbershop_alamat, bs.foto 
    FROM bookings b 
                                ...
                                <tbody>
                                    <?php foreach ($bookings as $booking): ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <?php if (!empty($booking['foto'])): ?>
                                                        <img src="../uploads/<?= htmlspecialchars($booking['foto']) ?>" alt="Foto Barbershop" class="me-2 barbershop-thumb">
                                                    <?php else: ?>
                                                        <div class="me-2 barbershop-thumb bg-light"></div>
                                                    <?php endif; ?>
                                                    <div>
                                            ...
                                            <td>
                                                <span class="badge bg-<?= $booking['status'] === 'pending' ? 'warning' : ($booking['status'] === 'dikonfirmasi' ? 'success' : 'secondary') ?>">
