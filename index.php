...
// Bangun query SQL dengan atau tanpa pencarian
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <?php if (!empty($barbershop['photo_path']) && file_exists($barbershop['photo_path'])): ?>
                            <img src="<?= htmlspecialchars($barbershop['photo_path']) ?>" alt="Foto <?= htmlspecialchars($barbershop['nama_barbershop']) ?>" class="barbershop-img">
                        <?php else: ?>
                            <div style="width:100%; height:180px; background:#eee; border-top-left-radius: .5rem; border-top-right-radius: .5rem;"></div>
                        <?php endif; ?>
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted"><?= substr($barbershop['jam_buka'], 0, 5) ?> - <?= substr($barbershop['jam_tutup'], 0, 5) ?></small>
                            </div>
                        </div>
